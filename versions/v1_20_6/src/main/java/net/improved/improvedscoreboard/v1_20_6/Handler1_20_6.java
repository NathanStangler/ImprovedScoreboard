package net.improved.improvedscoreboard.v1_20_6;
...
public class Handler1_20_6 implements Handler {
    private ClientboundSetObjectivePacket initSetObjective(String id, Component name, int method) {
        ...
        ReflectionHandler.setField(packet, Constants.SET_OBJECTIVE_NUMBER_FORMAT, Constants.NUMBER_FORMAT);
    ...
    public void setScore(Player player, String id, byte score) {
        sendPacket(player, new ClientboundSetScorePacket(Constants.COLORS[score], id,  score, Optional.empty(), Constants.NUMBER_FORMAT));
    }
    ...
    private ClientboundSetPlayerTeamPacket initSetTeam(Component prefix, int method, String id) {
        ...
        ReflectionHandler.setField(parameters, Constants.SET_TEAM_PARAMETERS_COLOR, Constants.RESET);
